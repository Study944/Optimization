...
if __name__ == '__main__':
    ...
    ger = 100 # [100,1000]
    dim = 200 # [2,100]
    his_13 = run_pso(w_strategy=0.4, ger=ger,dim=dim,c1=1,c2=3)
    his_22 = run_pso(w_strategy=0.4, ger=ger,dim=dim,c1=2,c2=2)
    his_31 = run_pso(w_strategy=0.4, ger=ger,dim=dim,c1=3,c2=1)
    # 5.绘图
    plt.figure(figsize=(10, 6))
    plt.plot(range(ger), his_13, label='c1=1,c2=3')
    plt.plot(range(ger), his_22, label='c1=2,c2=2')
    plt.plot(range(ger), his_31, label='c1=3,c2=1')
